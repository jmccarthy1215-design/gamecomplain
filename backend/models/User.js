...
const userSchema = new mongoose.Schema({
  ...
  email: {
    ...
    lowercase: true,   // Mongoose normalises to lowercase before save (belt-and-suspenders alongside route normalisation)
    trim:      true,
    unique:    true,
    sparse:    true,   // sparse: legacy username-only documents (email === null) do not participate in the uniqueness check
